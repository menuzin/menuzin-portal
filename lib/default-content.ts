...
/**
 * Default content matching the current Menuzin landing page
 */
export const getDefaultContent = (): SiteContent => {
  return {
    brand: {
      ...
      textColor: "#0F172A",
      logoUrl: undefined, // Can be set to "/menuzin-logo.png" or any URL
      logoHeight: 48, // Default height in pixels (48px mobile, 64px desktop will be applied via CSS)
    },
    navbar: {
      links: [
    ...
    hero: {
      headline: "Serve Better with Menuzin.",
      subheadline: "Empower your guests with a digital dining experience they'll love.",
      ctaLabel: "Contact Us",
      ctaHref: "#contact",
    },
    howItWorks: {
    ...
    whatsapp: {
      enabled: false,
      phone: "9647709160405", // Stored but not used unless enabled
    },
  };
};
